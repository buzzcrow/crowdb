...
//! `crowdb_protocol::mgmt` (the single home for cross-component protocol
...
pub use crowdb_protocol::mgmt::{
    CrowdbTreeStatsView as CrowdbTreeStatsSnapshot, ElectionStateView as ElectionStateSnapshot,
...
pub use crowdb_protocol::mgmt::GroupStatus as GroupView;
