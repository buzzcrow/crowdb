...
//! `crowdb-protocol` (`kv_consensus::rpc` for Paxos messages,
...
//! is crowdb-rpc (flatbuffer over TCP); the former transport server and
//! client modules have been removed.

pub use crowdb_protocol::kv_client::rpc::*;
pub use crowdb_protocol::kv_consensus::rpc::*;
...
// `crate::rpc::FB<Type>` without a direct `crowdb_protocol` import at
// every call site. These are the types from `kv_client_fb` (R117).
#[allow(unused_imports)]
pub(crate) use crowdb_protocol::kv_client_fb::{
    ...
    FBKvRevisionPrecondition, FBKvRevisionPreconditionArgs, FBKvScanItem, FBKvScanItemArgs, FBKvScanRequest,
    FBKvScanRequestArgs, FBKvScanResponse, FBKvScanResponseArgs, FBKvSetRequest, FBKvSetRequestArgs,
    FBListSnapshotsRequest, FBListSnapshotsRequestArgs, FBListSnapshotsResponse, FBListSnapshotsResponseArgs,
    FBReadMode, FBReleaseSnapshotRequest, FBReleaseSnapshotRequestArgs, FBReleaseSnapshotResponse,
    FBReleaseSnapshotResponseArgs, FBSnapshotInfo, FBSnapshotInfoArgs, FBSnapshotScanRequest,
    FBSnapshotScanRequestArgs, FBSnapshotScanResponse, FBSnapshotScanResponseArgs, FBWatchNotify,
    FBWatchNotifyArgs, FBWatchNotifyError, FBWatchNotifyErrorArgs, FBWatchSubscribe, FBWatchSubscribeArgs,
    FBWatchUnsubscribe, FBWatchUnsubscribeArgs,
};
