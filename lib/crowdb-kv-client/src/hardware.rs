...
//!
//! See `doc/design/kv/design-crowdb-kv-group0.md` §2.1, §3.
...
pub struct DiskRecord {
    ...
    pub disk_id: crowdb_protocol::common::DiskId,
    pub value: DiskValue,
}
...
impl HardwareClient {
    ...
    pub async fn list_disks_in_group(
        ...
        node_id: NodeId,
        dg_id: DiskGroupId,
    ) -> Result<Vec<(crowdb_protocol::common::DiskId, DiskValue)>> {
        ...
        for dg in &disk_groups {
            ...
            let disk_entries: Vec<DiskCapacityEntry> = dg_disks
                ...
                .map(|d| DiskCapacityEntry {
                    disk_id: crowdb_protocol::diskdb_type_util::DiskIdExt::to_display_string(&d.disk_id),
...
impl HardwareClient {
    ...
    pub async fn set_bind(
        ...
        let value = crowdb_protocol::common::BindMapValue { store_id, group_id };
        put_json(&self.kv, &key.to_path(), &value).await
    }
    ...
    pub async fn get_bind(
        ...
        let value = get_json::<crowdb_protocol::common::BindMapValue>(&self.kv, &key.to_path()).await?;
    ...
    pub async fn list_binds(&self) -> Result<Vec<KVGroupBindEntry>> {
        let entries = scan_prefix::<crowdb_protocol::common::BindMapValue>(
            &self.kv,
