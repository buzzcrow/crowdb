...
//! `ChunkdbClient` — client library for CROW chunkdb operations.
//!
...
/// Client for CROW chunkdb operations via crow-rpc.
...
impl ChunkdbClient {
    ...
    /// Execute a crow-rpc call with retry on transient errors.
