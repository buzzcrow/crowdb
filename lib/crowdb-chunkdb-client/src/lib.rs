...
//! Client library for CROWDB chunkdb.
//!
//! Provides allocate/append/seal/delete/query APIs with endpoint
//! caching, mirroring `crowdb-diskdb-client`'s pattern. The client
...
// direct crowdb-kv-client dependency for this one type.
pub use crowdb_kv_client::RangeBindingClient;
