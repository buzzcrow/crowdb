...
- [~] **Selected-use validation**: complete format semantics and validate
  ...
  7. Full v1/v2/v3 table metadata validation, preserving original JSON.
     ...
     Remaining: typed initial/write defaults, schema evolution and name mapping;
     partition/sort field semantics and evolution; new-commit versus historical
     validation; trusted manifest contexts and complete file-validation wiring.
