...
use crowdb_kv::cluster::status::{GroupStatus, RemoteStatus, ReplicaStatus, StoreStatus};
...
fn extract_port_from_members(members: &[crowdb_kv::cluster::group_config::PxGroupMember]) -> Option<u16> {
    members
        .iter()
...
#[openapi(
    ...
    tags((name = "management", description = "CrowDB management API"))
)]
