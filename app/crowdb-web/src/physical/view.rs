...
//! impls so the truncation walk in `crowdb_console_shared::expand` is
...
mod tests {
    use super::*;
    use crowdb_console_shared::cluster::{LocalReplicaInfo, NodeGroup, NodeStore};
    use crowdb_console_shared::config::{ConsoleConfig, NodeEntry, RackEntry};
