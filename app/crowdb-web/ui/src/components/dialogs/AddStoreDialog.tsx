 ...
 *
 * Backend contract: `crowdb-console/web/src/mgmt.rs::CreateStoreBody`.
 */
export function AddStoreDialog({
  ...
  return (
    <Dialog
      ...
      onClose={handleClose}
      title="Add KV Store"
      description="Create a new empty KV store on the selected CrowDB Storage nodes. Groups and replicas are created separately."
