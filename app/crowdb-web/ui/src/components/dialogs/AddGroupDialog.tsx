...
import { Node, EnrichedStoreView, CrowdbKVServerView } from '../../types';
      ...
      <div className="tw-space-y-4">
        ...
        <div className="tw-space-y-2">
          <label className="tw-text-xs tw-font-medium tw-text-text">
            Available CrowDB Storage nodes (select at least one — one local replica is created per node)
          </label>
          {availableNodes.length === 0 ? (
            <div className="tw-text-sm tw-text-muted">No reachable CrowDB Storage nodes are available.</div>
          ) : (
